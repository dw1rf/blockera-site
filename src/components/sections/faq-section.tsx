const faqs = [
  {
    ...
    answer:
      "Используем платёжный сервис EasyDonate: Visa, MasterCard, Мир, СБП."
  },
  {
    question: "Можно ли играть без доната?",
    answer:
      "Конечно. Донат ускоряет прогресс, но все возможности доступны и без него."
  },
  {
    question: "Где получить поддержку?",
    answer:
      "Вы можете создать обращение в telegram через бота поддержки @BlockEra_BOT или написать на почту blockera.play@inbox.ru."
  },
  {
